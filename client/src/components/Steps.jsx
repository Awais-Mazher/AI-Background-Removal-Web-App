...
const Steps = () => {
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-32'>
      ...
      <div className='flex items-start md:flex-nowrap flex-wrap gap-8 mt-16 xl:mt-24 justify-center'>

        {/* Steps */}

        <div className='flex items-start gap-4 bg-white border border-gray-100 drop-shadow p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
