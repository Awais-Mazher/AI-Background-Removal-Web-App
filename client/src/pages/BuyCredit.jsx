    ...
    <div className='min-h-[80vh] text-center pt-14 mb-20'>
        ...
        <div className='flex flex-wrap justify-center gap-6 text-left'>
          {plans.map((item, index)=>{
            return <div className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 border-gray-300 text-gray-700 hover:scale-105 transition-all duration-500' key={index}>
